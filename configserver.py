...
class ConfigManagerServicer(lib.config_pb2_grpc.ConfigManagerServicer):
    def getConfig(self, request, context):
        ...
        return lib.config_pb2.ProtocolConfig(adresse=adresse1,Port=port1)

def main():
    server =grpc.server(futures.ThreadPoolExecutor(max_workers=5))
    lib.config_pb2_grpc.add_ConfigManagerServicer_to_server(ConfigManagerServicer(),server)
